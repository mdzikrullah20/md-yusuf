  ...
  const projects: Project[] = [
    {
      ...
      fullDescription:
        "Developed Python scripts to automate network device configuration, backup, and monitoring tasks. Implemented APIs for network orchestration, reducing manual configuration time by 70% and improving network reliability.",
      image:
    ...
    },
    {
      ...
      fullDescription:
        "Designed and deployed hybrid cloud network infrastructure connecting on-premises data center with AWS and Azure cloud environments. Implemented secure connectivity, traffic routing, and network monitoring across hybrid infrastructure.",
      image:
    ...
    },
    {
      ...
      fullDescription:
        "Planned and deployed a high-density Wi-Fi 6 wireless network for a corporate campus. Conducted RF site surveys, implemented wireless controllers, and configured secure authentication and guest access.",
      image:
    ...
    <>
      ...
      >
        ...
        <div className="relative z-10 max-w-7xl mx-auto">
          ...
          >
            <h2 className="text-4xl text-white md:text-5xl font-bold mt-2 bg-gradient-to-r from-yellow-400 via-purple-400 to-pink-400 bg-clip-text text-transparent">
            ...
            {projects.map((project, i) => (
              <motion.div
                ...
                className="group relative bg-gray-900/50 backdrop-blur-sm border border-gray-800 
                           rounded-xl overflow-hidden cursor-pointer hover:border-yellow-500/50 
                ...
                <div className="relative p-6">
                  ...
                  <div className="flex flex-wrap gap-2 mb-4">
                    {project.technologies.slice(0, 3).map((tech) => (
                      <span
                        key={tech}
                        className="px-2 py-1 bg-yellow-500/10 text-yellow-400 text-xs rounded-full 
                  ...
                  <div className="flex gap-3">
                    {selectedProject.liveLink && (
                      <a
                        ...
                        className="p-3 bg-yellow-500 hover:bg-yellow-400 text-black rounded-lg 
