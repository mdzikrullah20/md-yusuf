  ...
  const socialLinks = [
    {
      ...
      href: "https://github.com/mdyusufraza7491-droid",
      label: "GitHub",
    },
    {
      icon: <Linkedin className="w-5 h-5" />,
      href: "https://www.linkedin.com/in/md-yusuf-raza-874845296?utm_source=share_via&utm_content=profile&utm_medium=member_android",
      label: "LinkedIn",
    },
    {
      icon: <Twitter className="w-5 h-5" />,
      href: "https://x.com/yusuf_raza7491?t=aHQtJAs9NPf9mRkZEIhX7g&s=09",
      label: "Twitter",
    },
    {
      icon: <Mail className="w-5 h-5" />,
      href: "mailto:mdyusufraza00786@gmail.com",
      label: "Email",
    },
    {
      icon: <Instagram className="w-5 h-5" />,
      href: "https://www.instagram.com/itzz____yusuf0786?igsh=MWVwNGhwMXR3OHE2ZA==",
      label: "Instagram",
    },
  ];
      ...
      <div className="relative z-10 flex flex-col lg:flex-row items-center justify-center max-w-7xl w-full mx-auto px-6 lg:px-8 gap-12 pt-16 pb-20">
        ...
        <div className="lg:w-1/2 md:text-center lg:text-left order-1 lg:order-1">
          ...
          <motion.h1
            ...
            className="text-3xl text-white sm:text-4xl lg:text-5xl font-bold mb-3 bg-linear-to-r from-purple-400 via-pink-400 to-blue-400 bg-clip-text leading-tight"
          >
            Md Yusuf Raza
          </motion.h1>
          ...
          >
            Specializing in routing, switching, and security configurations to deliver stable and secure network operations.
          </motion.p>
        ...
        >
          <div className=" relative w-84 h-106 sm:w-64 sm:h-64 md:w-100 md:h-100 lg:w-100 lg:h-[600px] rounded-md overflow-hidden cursor-pointer">
            <Image
              src="/Images/raza.png"
